...
--Pastikan nama yang di INSERT, dan urutan table harus sesuai dengan yang di CREATE biar gak error
--Dalam kasus ini, File CSV dari Google CLOUD Luke, so i just typed in and no worry
...
--Data Validation
--Jalankankan duckdb dw_mart.duckdb di GIT BASH
