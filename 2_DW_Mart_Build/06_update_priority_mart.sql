...
--Hati hati karena script ini UPDATE so kalo di run over and over bakalan ERROR terjadi kalo di running sebelum me run script 5
SELECT '=== Updating Roles for Priority Mart ===' AS info;

-- Update Data Engineer to Priority 1
UPDATE priority_mart.priority_roles
SET priority_lvl = 1
WHERE role_name = 'Data Enginner';
...
SELECT '=== Create temp table priority_jobs snapshot Priority Mart ===' AS info;
...
SELECT '=== Batch Updating priority_jobs snapshot Priority Mart ===' AS info;
--MERGE
